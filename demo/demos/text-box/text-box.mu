        ...
        Border [ Fill = @Surface, Stroke = Pen [ Brush = @OutlineVariant ], BorderThickness = (1) ] {
            ...
            DockPanel {
                ...
                Border [ DockPanel.Dock = Top, Fill = @Primary, Padding = (16,12,16,12) ] {
                    TextBlock
                        [ Text       = "TextBox demo — single-line + multi-line",
                          FontSize   = 15,
                          FontWeight = Bold,
                ...
                StackPanel [ Orientation = Horizontal ] {
                    ...
                    StackPanel [ Orientation = Vertical, Width = 300, Margin = (16,16,8,16) ] {
                        ...
                        TextBlock
                            [ Text       = "No scrollbar. Type / Home / End — text follows the caret.",
                              FontSize   = 11,
                    ...
                    StackPanel [ Orientation = Vertical, Width = 300, Margin = (8,16,8,16) ] {
                        ...
                        TextBlock
                            [ Text       = "Word-wrap. Resize the column to see lines re-flow.",
                              FontSize   = 11,
                              Foreground = @OnSurfaceVariant,
                              Margin     = (0,8,0,0) ]
                    }
                    ...
                    StackPanel [ Orientation = Vertical, Width = 300, Margin = (8,16,16,16) ] {
                        ...
                        TextBlock
                            [ Text       = "Both axes scroll; lines never break.",
                              FontSize   = 11,
                              Foreground = @OnSurfaceVariant,
                              Margin     = (0,8,0,0) ]
                    }
