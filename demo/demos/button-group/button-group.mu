                ...
                StackPanel [ Orientation = Vertical, Margin = (24,24,24,24) ] {
                    ...
                    ButtonGroup
                        [ BaseWidth           = 80,
                          ...
                          Margin              = (0,0,0,24) ] {
                        Button [ Variant = Tonal, Command = $UndoCommand ] {
                            TextBlock [ Text = "Undo" ]
                        }
                        Button [ Variant = Tonal, Command = $RedoCommand ] {
                            TextBlock [ Text = "Redo" ]
                        }
                        Button [ Variant = Tonal, Command = $CutCommand ] {
                            TextBlock [ Text = "Cut" ]
                        }
                        Button [ Variant = Tonal, Command = $CopyCommand ] {
                            TextBlock [ Text = "Copy" ]
                        }
                        Button [ Variant = Tonal, Command = $PasteCommand ] {
