...
export class NavigationRailDemo extends ResourceDictionary {
    ...
    static Clone() {
        ...
        const _tmpl0 = new DataTemplate((_data) => {
            ...
            _navigationRail6._set_property_value_by_name("SelectedDataItem", DataContextBinding(_navigationRail6, "SelectedItem"));
            ...
            _textBlock8._set_property_value_by_name("Text", "🏠");
            _textBlock8._set_property_value_by_name("FontSize", 22);
            ...
            _textBlock10._set_property_value_by_name("FontSize", 22);
            ...
            _textBlock12._set_property_value_by_name("FontSize", 22);
            ...
            _textBlock14._set_property_value_by_name("FontSize", 22);
