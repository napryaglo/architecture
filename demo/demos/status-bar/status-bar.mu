            ...
            Border [ Background         = @Surface,
                ...
                DockPanel {
                    ...
                    Border [ DockPanel.Dock = Top,
                             Background    = @Primary,
                             Padding       = (16,12,16,12) ] {
                        TextBlock [ Text       = "StatusBar — docked cells with separators.",
                                    FontSize   = 15,
                                    FontWeight = Bold,
                    ...
                    StatusBar [ DockPanel.Dock = Bottom ] {
                        ...
                        StatusBarItem [ DockPanel.Dock = Left ] {
                            TextBlock [ Text       = {{ $IsModified ? "● Modified" : "✓ Saved" }},
                        ...
                        StatusBarItem [ DockPanel.Dock = Right ] {
                            TextBlock [ Text       = {{ "Items: " + String($ItemCount) }},
                                        Foreground = @OnSurfaceVariant,
                                        FontSize   = 12 ]
                        }
                        ...
                        StatusBarItem [ DockPanel.Dock = Right ] {
                            TextBlock [ Text       = {{ "Last: " + String($LastAction) }},
                                        Foreground = @OnSurfaceVariant,
                                        FontSize   = 12 ]
                        }
                    ...
                    StackPanel [ Orientation = Vertical, Margin = (16,16,16,16) ] {
                        TextBlock [ Text       = "Use these buttons to change the cells in the bottom strip:",
                                    FontSize   = 12,
                                    FontWeight = Bold,
                                    Margin     = (0,0,0,8) ]
                        ...
                        TextBlock [ Text       = "Remove is gated by item count — its chrome dims when there's nothing to remove.",
                                    FontSize   = 11,
                                    Foreground = @OnSurfaceVariant,
                                    Margin     = (0,12,0,0) ]
                    }
