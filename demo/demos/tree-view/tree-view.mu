        ...
        Border x:root
            ...
            DockPanel {
                ...
                StackPanel [ Orientation = Horizontal ] {
                    ...
                    StackPanel [ Orientation = Vertical, Width = 300, Margin = (12,12,6,12) ] {
                        TextBlock
                            [ Text       = "Composed markup",
                              FontSize   = 12,
                              FontWeight = Bold,
                    ...
                    StackPanel [ Orientation = Vertical, Width = 300, Margin = (6,12,12,12) ] {
                        TextBlock
                            [ Text       = "HierarchicalDataTemplate",
                              FontSize   = 12,
                              FontWeight = Bold,
                              Foreground = @OnSurfaceVariant,
                              Margin     = (0,0,0,8) ]
