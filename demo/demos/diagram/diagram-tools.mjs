...
export class DiagramTool extends MuralBase {
    static IconKey = MuralBase.RegisterProperty(DiagramTool, 'Icon', undefined, MetaData.None);
    static CommandKey = MuralBase.RegisterProperty(DiagramTool, 'Command', undefined, MetaData.None);
