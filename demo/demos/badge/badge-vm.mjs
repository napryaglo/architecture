...
export class BadgeVM extends MuralBase {
    static CountKey = MuralBase.RegisterProperty(BadgeVM, 'Count', 3, MetaData.None);
    static IncrementKey = MuralBase.RegisterProperty(BadgeVM, 'Increment', null, MetaData.None);
    static ResetKey = MuralBase.RegisterProperty(BadgeVM, 'Reset', null, MetaData.None);
