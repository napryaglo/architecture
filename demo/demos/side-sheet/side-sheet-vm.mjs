...
export class SideSheetVM extends MuralBase {
    static IsOpenKey = MuralBase.RegisterProperty(SideSheetVM, 'IsOpen', false, MetaData.None);
    static OpenKey = MuralBase.RegisterProperty(SideSheetVM, 'Open', null, MetaData.None);
