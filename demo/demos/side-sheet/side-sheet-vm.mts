...
{
    static IsOpenKey = MuralBase.RegisterProperty<boolean>(SideSheetVM, 'IsOpen', false, MetaData.None);
    static OpenKey   = MuralBase.RegisterProperty<RelayCommand | null>(SideSheetVM, 'Open', null, MetaData.None);
