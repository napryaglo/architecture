            ...
            DockPanel {
                ...
                Border [DockPanel.Dock=Top, Background=@Primary, Padding=(20,14,20,14)] {
                    StackPanel [Orientation=Vertical] {
                        TextBlock [Text="PowerPoint-style Fill editor",
                                   FontSize=18, FontWeight=Bold,
                                   Foreground=@OnPrimary]
                        TextBlock [Text="Inline panel: None / Solid / Linear / Radial / Pattern / Picture + transparency.",
                ...
                Border [Background=@SurfaceContainerLowest, Padding=(20,20,20,20)] {
                    StackPanel [Orientation=Horizontal] {
                        ...
                        Border [Width=380, Padding=(16,16,16,16),
                                Background=@SurfaceContainerLow,
                                BorderBrush=@OutlineVariant,
                                BorderThickness=(1),
                                CornerRadius=8,
                                Margin=(0,0,20,0)] {
                            StackPanel [Orientation=Vertical] {
                                TextBlock [Text="Fill", FontSize=14, FontWeight=Bold, Foreground=@OnSurface, Margin=(0,0,0,12)]
                        ...
                        Border [Width=520, Height=420, Padding=(20),
                                ...
                                BorderThickness=(1),
                                CornerRadius=8] {
                            Rectangle [Width=480, Height=380,
                                       Fill=$Fill,
                                       Stroke=$OutlinePen]
                        }
                    }
