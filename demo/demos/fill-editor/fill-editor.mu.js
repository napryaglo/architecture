...
export class FillEditorDemo extends ResourceDictionary {
    ...
    static Clone() {
        ...
        const _tmpl0 = new DataTemplate((_data) => {
            ...
            _textBlock5._set_property_value_by_name("Text", "PowerPoint-style Fill editor");
            ...
            _textBlock6._set_property_value_by_name("Text", "Inline panel: None / Solid / Linear / Radial / Pattern / Picture + transparency.");
            ...
            _textBlock8._set_property_value_by_name("Text", DataContextBinding(_textBlock8, "FillSummary"));
            _textBlock8._set_property_value_by_name("FontSize", 11);
            ...
            _border9._set_property_value_by_name("Background", DynamicResource(_border9, "SurfaceContainerLowest"));
            _border9._set_property_value_by_name("Padding", new Thickness(20, 20, 20, 20));
            ...
            _border11._set_property_value_by_name("Width", 380);
            _border11._set_property_value_by_name("Padding", new Thickness(16, 16, 16, 16));
            _border11._set_property_value_by_name("Background", DynamicResource(_border11, "SurfaceContainerLow"));
            ...
            _border11._set_property_value_by_name("CornerRadius", 8);
            _border11._set_property_value_by_name("Margin", new Thickness(0, 0, 20, 0));
            ...
            _textBlock13._set_property_value_by_name("Text", "Fill");
            ...
            _textBlock13._set_property_value_by_name("Margin", new Thickness(0, 0, 0, 12));
            _stackPanel12.AddChild(_textBlock13);
            const _fillEditor14 = new FillEditor();
            _fillEditor14._set_property_value_by_name("Fill", DataContextBinding(_fillEditor14, "Fill"));
            ...
            _border15._set_property_value_by_name("Width", 520);
            _border15._set_property_value_by_name("Height", 420);
            _border15._set_property_value_by_name("Padding", new Thickness(20));
            _border15._set_property_value_by_name("Background", DynamicResource(_border15, "SurfaceContainer"));
            ...
            _border15._set_property_value_by_name("CornerRadius", 8);
            const _rectangle16 = new Rectangle();
            _rectangle16._set_property_value_by_name("Width", 480);
            _rectangle16._set_property_value_by_name("Height", 380);
            _rectangle16._set_property_value_by_name("Fill", DataContextBinding(_rectangle16, "Fill"));
            _rectangle16._set_property_value_by_name("Stroke", DataContextBinding(_rectangle16, "OutlinePen"));
