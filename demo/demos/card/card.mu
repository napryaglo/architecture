        ...
        Border [Background=@Surface, BorderBrush=@OutlineVariant,
            ...
            DockPanel{
                ...
                Border[DockPanel.Dock=Top,
                    ...
                    TextBlock[Text="Card — M3's content container. Three variants vary container colour, border, and resting elevation.",
                ...
                StackPanel[Orientation=Vertical, Margin=(24,24,24,24)]{
                    ...
                    TextBlock[Text="Card — Variant: Filled / Elevated / Outlined",
                              FontWeight=Bold, FontSize=14,
                              Foreground=@OnSurface, Margin=(0,0,0,16)]
                        ...
                        Card[Variant=Filled, Width=240, Margin=(0,0,24,0)]{
                            StackPanel[Orientation=Vertical]{
                                TextBlock[Text="Filled",
                                          ...
                                          Margin=(0,0,0,8)]
                                TextBlock[Text="SurfaceContainerHighest base, no border, no resting elevation. Hover bumps to Level1.",
                        ...
                        Card[Variant=Elevated, Width=240, Margin=(0,0,24,0)]{
                            StackPanel[Orientation=Vertical]{
                                TextBlock[Text="Elevated",
                                          ...
                                          Foreground=@OnSurface,
                                          Margin=(0,0,0,8)]
                                TextBlock[Text="SurfaceContainerLow base, no border, resting ElevationLevel1. Hover bumps to Level2.",
                                          FontFamily=@BodyMediumFont,
                                          FontSize=@BodyMediumSize,
                                          LineHeight=@BodyMediumLineHeight,
                                          Foreground=@OnSurfaceVariant,
                        ...
                        Card[Variant=Outlined, Width=240]{
                            StackPanel[Orientation=Vertical]{
                                TextBlock[Text="Outlined",
                                          ...
                                          Foreground=@OnSurface,
                                          Margin=(0,0,0,8)]
                                TextBlock[Text="Surface base, 1-DIP Outline border, no resting elevation. Hover bumps to Level1.",
                                          FontFamily=@BodyMediumFont,
                                          FontSize=@BodyMediumSize,
                                          LineHeight=@BodyMediumLineHeight,
                                          Foreground=@OnSurfaceVariant,
                    ...
                    StackPanel[Orientation=Horizontal]{
                        TextBlock[Text="Actions — Filled: ", FontSize=12, Foreground=@OnSurfaceVariant]
                        TextBlock[Text=$FilledActions,        FontSize=12, FontWeight=Bold, Foreground=@OnSurface]
                        TextBlock[Text="  Elevated: ",        FontSize=12, Foreground=@OnSurfaceVariant]
                        TextBlock[Text=$ElevatedActions,      FontSize=12, FontWeight=Bold, Foreground=@OnSurface]
                        TextBlock[Text="  Outlined: ",        FontSize=12, Foreground=@OnSurfaceVariant]
                        TextBlock[Text=$OutlinedActions,      FontSize=12, FontWeight=Bold, Foreground=@OnSurface]
                    }
                }
            }
        }
