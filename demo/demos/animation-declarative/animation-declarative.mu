        ...
        Border [ Background = @Surface, BorderBrush = @OutlineVariant, BorderThickness = (1) ] {
            resources: {
                ...
                Style [TargetType = Button] {
                    on Click {
                        BeginStoryboard { DoubleAnimation [TargetProperty = Width, From = 80, To = 240, Duration = 400] }
                    }
                }
            }
            DockPanel {
                ...
                StackPanel [ Orientation = Vertical, Margin = (20,24,20,20) ] {
                    TextBlock
                        [ Text       = "Click any Button. The style's EventTrigger animates the Button's own Width from 80 to 240 over 400 ms — no host-side handler wired.",
                          FontSize   = 12,
                    ...
                    TextBlock
                        [ Text       = "Each Button carries its own animation instance — clicking them simultaneously plays independent storyboards (each baseline-captures From=80 at fire time).",
                          FontSize   = 11,
                          Foreground = @OnSurfaceVariant,
                          Margin     = (0,16,0,0) ]
                }
