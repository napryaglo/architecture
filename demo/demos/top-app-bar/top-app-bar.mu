...
resources TopAppBarDemo {
    ...
    DataTemplate x:key="TopAppBarTemplate" [DataType=TopAppBarVM] {
        Border [Background=@SurfaceContainerLow, BorderBrush=@OutlineVariant,
                BorderThickness=(1)]{
            DockPanel{
                // Header strip
                Border[DockPanel.Dock=Top,
                       Background=@Primary, Padding=(16,12,16,12)]{
                    TextBlock[Text="TopAppBar — M3 screen header. Four variants vary title alignment and row count.",
                ...
                StackPanel[Orientation=Vertical, Margin=(24,24,24,24)]{
                    ...
                    // Small ───────────────────────────────────────────
                    TextBlock[Text="Small — single row, leading-aligned title.",
                              FontWeight=Bold, FontSize=12,
                              Foreground=@OnSurfaceVariant, Margin=(0,0,0,8)]
                    Border[Background=@OutlineVariant, BorderThickness=(0), Margin=(0,0,0,16)]{
                    ...
                    // CenterAligned ───────────────────────────────────
                    TextBlock[Text="CenterAligned — single row, centered title.",
                              FontWeight=Bold, FontSize=12,
                              Foreground=@OnSurfaceVariant, Margin=(0,0,0,8)]
                    Border[Background=@OutlineVariant, BorderThickness=(0), Margin=(0,0,0,16)]{
                    ...
                    // Medium ──────────────────────────────────────────
                    TextBlock[Text="Medium — two rows, HeadlineSmall title (112dp tall).",
                              FontWeight=Bold, FontSize=12,
                              Foreground=@OnSurfaceVariant, Margin=(0,0,0,8)]
                    Border[Background=@OutlineVariant, BorderThickness=(0), Margin=(0,0,0,16)]{
                    ...
                    // Large ───────────────────────────────────────────
                    TextBlock[Text="Large — two rows, HeadlineMedium title (152dp tall).",
                              FontWeight=Bold, FontSize=12,
                              Foreground=@OnSurfaceVariant, Margin=(0,0,0,8)]
                    Border[Background=@OutlineVariant, BorderThickness=(0), Margin=(0,0,0,16)]{
                    ...
                    StackPanel[Orientation=Horizontal, Margin=(0,8,0,0)]{
                        TextBlock[Text="Clicks — Search: ", FontSize=12, Foreground=@OnSurfaceVariant]
                        TextBlock[Text=$SearchClicks,        FontSize=12, FontWeight=Bold, Foreground=@OnSurface]
                        TextBlock[Text="  More: ",           FontSize=12, Foreground=@OnSurfaceVariant]
                        TextBlock[Text=$MoreClicks,          FontSize=12, FontWeight=Bold, Foreground=@OnSurface]
                    }
                }
            }
        }
