            ...
            ScrollViewer{
                Border [Padding=(24,24,24,24), Background=@Surface]{
                    StackPanel [Orientation=Vertical]{
                        TextBlock [Text="M3 Expressive Shape Library",
                                   FontSize=24, FontWeight=Bold,
                                   Foreground=@OnSurface, Margin=(0,0,0,8)]
                        TextBlock [Text="35 named shapes from the M3 Expressive shape system — base + architectural + cookies + clovers + radial waves + puffies + glyphs + pixel art. Rows 1-2 are the round/rectangular base + diamond/pentagon/gem; rows 3-4 architectural + N-sided cookies; row 5 spans clovers into the radial-wave family; row 6 finishes the radial waves + puffies; row 7 the special glyphs + pixel art.",
                                   FontSize=13, TextWrapping=Wrap,
                                   Foreground=@OnSurfaceVariant, Margin=(0,0,0,24)]
                        ...
                        TextBlock [Text="All 35 shapes live — Circle / Oval delegate to Ellipse, Square delegates to Squircle. The remaining named shapes ship as parametric families (Cookie, Clover, RadialWave, Puffy, PixelArt) with named-stop aliases that just override metadata defaults.",
                                   FontSize=11, TextWrapping=Wrap,
                                   Foreground=@OnSurfaceVariant, Margin=(0,24,0,0)]
                    }
                }
            }
        }
