...
export class BouncingBallVM extends Model
{
    ...
    static XKey        = Model.RegisterProperty<number>(BouncingBallVM, 'X',        0,        MetaData.None);
    static YKey        = Model.RegisterProperty<number>(BouncingBallVM, 'Y',        0,        MetaData.None);
    static DiameterKey = Model.RegisterProperty<number>(BouncingBallVM, 'Diameter', DIAMETER, MetaData.None);
