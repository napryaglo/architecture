        ...
        Border [Background=@Surface, BorderBrush=@OutlineVariant, BorderThickness=(1)]{
            DockPanel{
                Border [DockPanel.Dock=Top,
                    ...
                    TextBlock [Text="SegmentedButton — M3's connected-segment selection row. Single-select and Multi-select variants drive off SelectionMode.",
                ...
                StackPanel [Orientation=Vertical, Margin=(24,24,24,24)]{
                    ...
                    TextBlock [Text="Single-select — pick one timeframe",
                               FontWeight=Bold, FontSize=14,
                               Foreground=@OnSurface, Margin=(0,0,0,12)]

                    SegmentedButton [ Items          = $Timeframes,
                    ...
                    StackPanel [Orientation=Horizontal, Margin=(0,0,0,24)]{
                        TextBlock [Text="Selected: ", FontSize=12, Foreground=@OnSurfaceVariant]
                        TextBlock [Text=$SelectedTimeframe, FontSize=12, FontWeight=Bold, Foreground=@OnSurface]
                    }

                    // ── Row 2: Multi-select format toggles ────────────
                    TextBlock [Text="Multi-select — pick one or more formats",
                               FontWeight=Bold, FontSize=14,
                               Foreground=@OnSurface, Margin=(0,0,0,12)]

                    SegmentedButton [ Items               = $FormatChoices,
                    ...
                    StackPanel [Orientation=Horizontal]{
                        TextBlock [Text="Selected: ", FontSize=12, Foreground=@OnSurfaceVariant]
                        TextBlock [Text=$SelectedFormatsLabel, FontSize=12, FontWeight=Bold, Foreground=@OnSurface]
                    }
                }
            }
        }
