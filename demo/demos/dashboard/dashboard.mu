...
ResourceDictionary {
    ...
    Style x:key="DashboardPrimaryCard" [TargetType=Border]{
        ...
        CornerRadius    = (8);
        Padding         = (16);
        when( IsMouseOver ){ Background = #66bb6a; BorderThickness = (3); }
    ...
    Style x:key="DashboardDangerCard" [TargetType=Border]{
        ...
        CornerRadius    = (8);
        Padding         = (16);
        when( IsMouseOver ){ Background = #ef5350; BorderThickness = (3); }
    ...
    DataTemplate x:key="DashboardTemplate" [DataType=DashboardVM] {
        Canvas {
            ...
            Border[Style=@DashboardPrimaryCard,
            ...
            Border[Style=@DashboardDangerCard,
            ...
            Border[Style=@DashboardPaperCard,
