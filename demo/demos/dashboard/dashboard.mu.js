...
export class DashboardDemo extends ResourceDictionary {
    ...
    static Clone() {
        ...
        const _setter5 = new Setter(Border, "Fill", new SolidColorBrush(Color.FromHex('#66bb6a')));
        ...
        const _setter9 = new Setter(Border, "Fill", new SolidColorBrush(Color.FromHex('#2e7d32')));
        ...
        const _setter19 = new Setter(Border, "Fill", new SolidColorBrush(Color.FromHex('#ef5350')));
        ...
        const _setter23 = new Setter(Border, "Fill", new SolidColorBrush(Color.FromHex('#b71c1c')));
        ...
        const _setter33 = new Setter(Border, "Fill", new SetterFactory((_t) => DynamicResource(_t, "SurfaceContainerHigh")));
        ...
        const _setter37 = new Setter(Border, "Fill", new SetterFactory((_t) => DynamicResource(_t, "OutlineVariant")));
