...
export function create() {
    ...
    const _tmpl43 = new DataTemplate((_data) => {
        ...
        _border45.set_property_value("Style", Application.current.Resources.Resolve("DashboardPrimaryCard"));
        ...
        _textBlock46.set_property_value("Foreground", new SolidColorBrush(Color.FromHex('#ffffff')));
        _border45.SetChild(_textBlock46);
        _canvas44.AddChild(_border45);
        const _border47 = new Border();
        _border47.set_property_value("Style", Application.current.Resources.Resolve("DashboardDangerCard"));
        ...
        _textBlock48.set_property_value("Foreground", new SolidColorBrush(Color.FromHex('#ffffff')));
        _border47.SetChild(_textBlock48);
        _canvas44.AddChild(_border47);
        const _border49 = new Border();
        _border49.set_property_value("Style", Application.current.Resources.Resolve("DashboardPaperCard"));
        ...
        _textBlock50.set_property_value("Foreground", new SolidColorBrush(Color.FromHex('#1f2937')));
