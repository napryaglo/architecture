...
export function create() {
    ...
    const _tmpl1 = new DataTemplate((_data) => {
        ...
        _border10._set_property_value_by_name("Background", DynamicResource(_border10, "SurfaceContainerLow"));
        _border10._set_property_value_by_name("BorderThickness", new Thickness(0, 0, 1, 0));
        _border10._set_property_value_by_name("BorderBrush", DynamicResource(_border10, "OutlineVariant"));
        ...
        _border22._set_property_value_by_name("Background", DynamicResource(_border22, "Surface"));
