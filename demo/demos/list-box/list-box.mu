            ...
            DockPanel {
                ...
                StackPanel [ Orientation = Horizontal ] {
                    ...
                    StackPanel [ Orientation = Vertical, Width = 240, Margin = (12,12,6,12) ] {
                        TextBlock
                            [ Text       = "Declarative + marquee select",
                              FontSize   = 12,
                              FontWeight = Bold,
                              Margin     = (0,0,0,4) ]
                        TextBlock
                            [ Text         = "Drag in empty space to marquee-select. Ctrl=add. Shift=extend.",
                              FontSize     = 10,
                              Foreground   = @OnSurfaceVariant,
                              TextWrapping = Wrap,
                              Margin       = (0,0,0,8) ]
                        ListBox [ SelectionMode = Extended, AllowMarqueeSelection = true ] {
                            ListBoxItem {
                                TextBlock [ Text = "Apples" ]
                            }
                            ListBoxItem {
                                TextBlock [ Text = "Bananas" ]
                            }
                            ListBoxItem {
                                TextBlock [ Text = "Cherries" ]
                            }
                            ListBoxItem {
                                TextBlock [ Text = "Durian" ]
                            }
                            ListBoxItem {
                                TextBlock [ Text = "Elderberry" ]
                            }
                            ListBoxItem {
                                TextBlock [ Text = "Fig" ]
                            }
                    ...
                    StackPanel [ Orientation = Vertical, Width = 240, Margin = (6,12,12,12) ] {
                        TextBlock
                            [ Text       = "ItemsSource + CollectionView",
                              FontSize   = 12,
                              FontWeight = Bold,
                              Margin     = (0,0,0,8) ]
