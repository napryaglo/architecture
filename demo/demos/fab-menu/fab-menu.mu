...
resources FabMenuDemo {
    ...
    DataTemplate x:key="FabMenuTemplate" [DataType=FabMenuVM] {
        Border [Background=@Surface, BorderBrush=@OutlineVariant, BorderThickness=(1)]{
            DockPanel{
                Border [DockPanel.Dock=Top,
                        Background=@Primary, Padding=(16,12,16,12)]{
                    TextBlock [Text="FabMenu — M3 2024 FAB that reveals secondary actions on tap. Stagger-fade reveal; tap the FAB again or click the scrim to dismiss.",
                ...
                StackPanel [Orientation=Vertical, Margin=(24,24,24,24)]{
                    ...
                    StackPanel [Orientation=Horizontal]{
                        TextBlock [Text="Clicks — Create: ",  FontSize=12, Foreground=@OnSurfaceVariant]
                        TextBlock [Text=$CreateClicks,        FontSize=12, FontWeight=Bold, Foreground=@OnSurface]
                        TextBlock [Text="  Upload: ",          FontSize=12, Foreground=@OnSurfaceVariant]
                        TextBlock [Text=$UploadClicks,        FontSize=12, FontWeight=Bold, Foreground=@OnSurface]
                        TextBlock [Text="  Share: ",           FontSize=12, Foreground=@OnSurfaceVariant]
                        TextBlock [Text=$ShareClicks,         FontSize=12, FontWeight=Bold, Foreground=@OnSurface]
                    }
                }
            }
        }
