    ...
    DataTemplate x:key="TextOnPathTemplate" [DataType=TextOnPathVM] {
        Border x:root [Background=@Surface] {
            DockPanel {
                ...
                // ── Controls strip ────────────────────────────────
                Border [DockPanel.Dock=Top, Padding=(20,12,20,12),
                       BorderBrush=@OutlineVariant, BorderThickness=(0,0,0,1)] {
                    StackPanel [Orientation=Horizontal] {
                        StackPanel [Orientation=Vertical, Margin=(0,0,24,0)] {
                            TextBlock [Text="Text", FontSize=11, FontWeight=Bold,
                                       Foreground=@OnSurface, Margin=(0,0,0,4)]
                            TextBox [Width=320, Text=$Text]
                        }
                        StackPanel [Orientation=Vertical, Margin=(0,0,24,0)] {
                            TextBlock [Text="Path", FontSize=11, FontWeight=Bold,
                                       Foreground=@OnSurface, Margin=(0,0,0,4)]
                            ComboBox [Width=220,
                                      Items=$Paths,
                        ...
                        StackPanel [Orientation=Vertical, Margin=(0,0,24,0)] {
                            TextBlock [Text="Font size", FontSize=11, FontWeight=Bold,
                                       Foreground=@OnSurface, Margin=(0,0,0,4)]
