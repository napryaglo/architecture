...
export class TextOnPathVM extends MuralBase {
    ...
    static PathsKey = MuralBase.RegisterProperty(TextOnPathVM, 'Paths', undefined, MetaData.None);
    static SelectedPathOptionKey = MuralBase.RegisterProperty(TextOnPathVM, 'SelectedPathOption', undefined, MetaData.None);
    ...
    static TogglePathCommandKey = MuralBase.RegisterProperty(TextOnPathVM, 'TogglePathCommand', undefined, MetaData.None);
    static ToggleGlyphsCommandKey = MuralBase.RegisterProperty(TextOnPathVM, 'ToggleGlyphsCommand', undefined, MetaData.None);
    ...
    constructor() {
        ...
        for (const p of PATHS)
            opts.Add(new PathOption(p.key, p.label));
        ...
        // MuralBase context.
        this.set_property_value(TextOnPathVM.TogglePathCommandKey, new RelayCommand(() => { this.ShowPath = !this.ShowPath; }, () => true));
        this.set_property_value(TextOnPathVM.ToggleGlyphsCommandKey, new RelayCommand(() => { this.ShowGlyphs = !this.ShowGlyphs; }, () => true));
    }
