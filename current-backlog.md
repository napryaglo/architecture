...
- 🟡 **Partial (still open below):** 18.9 (BottomAppBar + LoadingIndicator shipped — 2 of 6; SideSheet/DatePicker/TimePicker/Carousel remain), 18.12 (SplitButton.PopupTemplate + MenuButton.TriggerTemplate done; MenuButton.Template + Drawer residuals).
