...
- 🟡 **Partial (still open below):** 18.9 (BottomAppBar shipped — 1 of 6; LoadingIndicator/SideSheet/DatePicker/TimePicker/Carousel remain), 18.12 (SplitButton.PopupTemplate + MenuButton.TriggerTemplate done; MenuButton.Template + Drawer residuals).
