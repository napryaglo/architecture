...
| Time pickers — Modal / Docked | [time-pickers](https://m3.material.io/components/time-pickers/overview) | ✅ dial shipped — `TimePicker` (analog clock: hour/minute rings + AM/PM); Modal dialog wrapper deferred ([backlog § 18.9](current-backlog.md)) | ~~8.10~~ |
