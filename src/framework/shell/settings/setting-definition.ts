...
//
// A MuralBase so it is DP-backed, bindable, and declarable in markup:
//
...
export class SettingDefinition extends MuralBase
{
    ...
    public static readonly CategoryKey = MuralBase.RegisterProperty<string>(
        SettingDefinition, 'Category', '', MetaData.None);

    // The value shape — picks the editor and the parse/serialize path.
    public static readonly KindKey = MuralBase.RegisterProperty<SettingKind>(
    ...
    // FilePath / Choice.
    public static readonly DefaultKey = MuralBase.RegisterProperty<unknown>(
    ...
    public static readonly MinKey = MuralBase.RegisterProperty<number>(
        SettingDefinition, 'Min', Number.NEGATIVE_INFINITY, MetaData.None);

    public static readonly MaxKey = MuralBase.RegisterProperty<number>(
