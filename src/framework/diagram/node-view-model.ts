...
export class NodeViewModel extends MuralBase
{
    ...
    public static readonly IdKey = MuralBase.RegisterProperty<string | undefined>(NodeViewModel, 'Id', undefined, MetaData.None);
