...
// The diagram's inspector view-model — what DiagramDocument.Inspector exposes and
// the shell's inspector region presents (via DataTemplate[DataType=DiagramInspector]).
//
...
export class DiagramInspector extends Model
{
