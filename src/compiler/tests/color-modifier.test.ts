...
describe('color modifier `<<`', () => {
    test('color literal + single modifier → folded to a constant', () => {
        const js = emitted(wrap('Fill=#0d47a1 << Lighten(0.5)'));
