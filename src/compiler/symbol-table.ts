...
const ENTRIES: ReadonlyArray<readonly [string, string]> = [
    ...
    ['TriggerUnset',        '@visualisation-sub/mural/runtime'],
    ['TriggerSet',          '@visualisation-sub/mural/runtime'],
    ...
    ['BottomAppBar',            '@visualisation-sub/mural/framework/bottom-app-bar/bottom-app-bar.js'],
    ...
    ['ToolBarSplitButton',      '@visualisation-sub/mural/framework/surface.js'],
