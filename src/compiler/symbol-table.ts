...
const ENTRIES: ReadonlyArray<readonly [string, string]> = [
    ...
    ['InspectorService',        '@pragmatic-lab/mural/framework/shell/services/inspector-service.js'],
    ['DialogService',           '@pragmatic-lab/mural/framework/shell/services/dialog-service.js'],
    ['InspectorPanel',          '@pragmatic-lab/mural/framework/shell/inspector/inspector-panel.js'],
    ['InspectorStack',          '@pragmatic-lab/mural/framework/shell/inspector/inspector-stack.js'],
