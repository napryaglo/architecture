...
const ENTRIES: ReadonlyArray<readonly [string, string]> = [
    ...
    ['DiagramNode',             '@visualisation-sub/mural/framework/diagram/figure.js'],
    ...
    ['SegmentedButton',         '@visualisation-sub/mural/framework/segmented-button.js'],
    ['SegmentedItem',           '@visualisation-sub/mural/framework/segmented-button.js'],
    ['SegmentedPosition',       '@visualisation-sub/mural/framework/segmented-button.js'],
    ['ButtonGroup',             '@visualisation-sub/mural/framework/button-group.js'],
    ['SplitButton',             '@visualisation-sub/mural/framework/split-button.js'],
