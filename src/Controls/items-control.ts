...
export { ItemsPanelTemplate } from './items-panel-template.js';
export type { ItemsPanelFactory } from './items-panel-template.js';
import { ItemsPanelTemplate, type ItemsPanelFactory } from './items-panel-template.js';
